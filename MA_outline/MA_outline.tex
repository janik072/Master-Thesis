...
\title{%
    ...
    \normalsize\textit{Master's Thesis Computer Science}
}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lX}
        ...
        Response caching     & Hash over prompt $\to$ cache lookup \\
        Batch API            & Utilizing Batch APIs for cost-efficient bulk processing. \\
        Local models         & Ollama for development and testing                            \\
        \bottomrule
    \end{tabularx}
    \caption{Cost optimization strategies.}
    \label{tab:cost}
\end{table}
